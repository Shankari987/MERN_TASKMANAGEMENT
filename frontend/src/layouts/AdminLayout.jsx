...
export const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Task Management', path: '/admin/tasks', icon: CheckSquare },
    { name: 'Create Task', path: '/admin/tasks/create', icon: PlusCircle },
  ];
      ...
      >
          ...
          <div className="h-16 px-6 flex items-center justify-between border-b border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-indigo-400 font-medium tracking-wide uppercase">Admin Portal</span>
              </div>
            </div>
            <button
              onClick={() => setMobileMenuOpen(false)}
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3 px-2 py-2 mb-2">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center font-bold text-white shadow">
